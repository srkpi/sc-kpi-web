...
const documents = [
  {
    title: 'Положення про ОСС',
    link: 'https://t.me/oss_kpi_archive/105',
    description:
      'Положення про студентське самоврядування Національного технічного університету України "Київський політехнічний інститут імені Ігоря Сікорського" затверджене протоколом №1 засідання Конференції студентів КПІ ім. Ігоря Сікорського від 27.04.2024, із змінами затвердженими протоколом №2 засідання Конференції студентів КПІ ім. Ігоря Сікорського від 04.05.2024.',
  },
  {
    title: 'Закон про вищу освіту',
