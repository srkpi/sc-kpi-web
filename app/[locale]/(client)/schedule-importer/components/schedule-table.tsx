...
import ScheduleCard from '@/app/[locale]/(client)/schedule-importer/components/schedule-card';
import ScheduleImport from '@/app/[locale]/(client)/schedule-importer/components/schedule-import';
import {
  DAYS,
  DAYS_SHORT_FORM,
  TIMES,
} from '@/app/[locale]/(client)/schedule-importer/constants';
import { EventsData } from '@/app/[locale]/(client)/schedule-importer/types';
import createEventsTable from '@/app/[locale]/(client)/schedule-importer/utils/createEventsTable';
import { getPairs } from '@/app/[locale]/actions/schedule.actions';
