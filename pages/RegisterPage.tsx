...
interface RegisterPageProps {
  faculties: IFacultyData[];
  groups: IGroupData[];
}

const RegisterPage: FC<RegisterPageProps> = ({ faculties, groups }) => {
  const [availableGroups, setAvailableGroups] = useState<IGroupData[]>(groups);
  ...
  useEffect(() => {
    const filteredGroups =
      groups.filter((group: IGroupData) => {
