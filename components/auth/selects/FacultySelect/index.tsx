    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        <Button
          ...
          aria-expanded={open}
          size="sm"
          className="justify-between text-wrap relative gap-[5px] p-[10px] overflow-hidden"
        >
      ...
      <PopoverContent
        ...
        className="p-0 border-none rounded-[10px] w-full max-w-[calc(100vw-40px)] md:max-w-[calc(100vw-80px)] lg:max-w-[calc(100vw-140px)]"
        side="bottom"
        align="start"
